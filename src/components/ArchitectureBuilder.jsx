      ...
      <div className="max-w-7xl mx-auto animate-fade-in">
        ...
        <div className="flex flex-wrap justify-between items-center mb-6 p-4 rounded-xl glass border border-[#3A506B]/20 gap-3">
          <div className="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <button
              onClick={clearCanvas}
              className="px-3 py-1.5 rounded-lg border border-slate-300 dark:border-white/10 text-slate-500 hover:text-red-500 transition-all text-xs font-bold"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-3 p-6 rounded-2xl glass border border-[#3A506B]/20 bg-slate-50 dark:bg-black/20 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3">
                {nodeTemplates.map(template => (
                  <button
                    ...
                    className="w-full p-3 rounded-lg border border-[#3A506B]/20 dark:border-white/5 hover:border-[#00E5FF]/40 bg-white/5 hover:bg-[#00E5FF]/5 transition-all text-right rtl:text-right ltr:text-left flex justify-between items-center group text-xs font-semibold"
                  >
                    <div>
                      <span className="text-[10px] text-slate-400 dark:text-cyber-muted block font-mono uppercase">{template.type}</span>
                      <span className="text-slate-800 dark:text-white group-hover:text-[#00E5FF] font-bold">{template.name.split(' ')[0]}</span>
                    </div>
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 rounded text-[8px] font-mono font-bold tracking-wider uppercase transition-all ${
                        isLinkingSource 
                          ...
                          : 'bg-white/10 text-[#00E5FF] hover:bg-[#00E5FF]/20'
                      }`}
                    >
