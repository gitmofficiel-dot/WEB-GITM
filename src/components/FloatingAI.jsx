    ...
    <>
      <div className="fixed bottom-6 right-6 rtl:left-6 rtl:right-auto z-[100]">
        ...
        <motion.button
          ...
          className={`w-14 h-14 rounded-full shadow-2xl flex items-center justify-center text-white transition-all duration-300 ${isOpen ? 'bg-slate-700 hover:bg-slate-50 dark:bg-slate-800 rotate-90' : 'bg-gradient-to-r from-teal-500 to-cyan-500 hover:shadow-sm'}`}
        >
