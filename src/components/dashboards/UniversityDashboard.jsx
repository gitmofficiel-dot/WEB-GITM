...
import { 
  ...
  FileText, TrendingUp, Calendar, CheckCircle, BarChart3, Building
} from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="p-5 border border-slate-200 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900/50">
                      ...
                      <p className="text-sm text-slate-500 flex items-center gap-2 mb-1"><Users size={14}/> {c.students} Students</p>
