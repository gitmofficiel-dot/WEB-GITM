                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl text-center">
                          <p className="text-xs text-slate-400 mb-1">{lang === 'ar' ? 'الموعد النهائي' : 'Deadline'}</p>
                        ...
                        <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl text-center">
                          <p className="text-xs text-slate-400 mb-1">{lang === 'ar' ? 'المهام' : 'Tasks'}</p>
                          <p className="text-sm font-bold text-[#1e3a5f] dark:text-white flex items-center justify-center gap-1">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-slate-400 mt-2 flex items-center gap-1"><Clock size={11}/> {req.submittedDate}</p>
                                </div>
                              </div>
                            </div>
