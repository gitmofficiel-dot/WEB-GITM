        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-card rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 mt-10">
             ...
             <div className="space-y-3">
               ...
               <button onClick={handleAddMember} className="w-full py-2 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-xl text-slate-500 font-bold hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors flex justify-center items-center gap-2">
